    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.CharField(blank=True, choices=[('Inner London', 'Inner London'), ('Outer London', 'Outer London')], max_length=30, null=True)),
                ('borrow', models.CharField(blank=True, max_length=50, null=True)),
